...
//    private final static String APP_ID = "wx29a83146136858f7";
//
//    private final static String APP_PARTNER = "1480662322";
//    private final static String APP_KEY = "LQ201711021449a257joker378q18101";
//清远  
    private final static String APP_ID = "wxdaf587e660ea2582";

    private final static String APP_PARTNER = "1385733902";
    private final static String APP_KEY = "Qykxlqyx201711061531hyjrwlyx8888";
...
//                "<re_user_name>" + name + "</re_user_name>" +
    ...
    private static CloseableHttpClient getHttpsInst() {
        ...
        try {
            ...
            FileInputStream instream = new FileInputStream(new File("/home/28h5/apiclient_cert.p12"));
            try {
