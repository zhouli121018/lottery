...
//	}
	...
	@Override
	public int sumSubByManagerId(int managerId,String levelStr,double rebate) {
		//0是查询全部1是查本周2是查上周3是查本月4是查上月
				Date startTime = null;
				Date endTime = null;
				startTime = new Date(0L);
	...
	@Override
	public int sumSubByManagerId2(int managerId, int sumType,String levelStr,double rebate) {
		//0是查询全部1是查本周2是查上周3是查本月4是查上月
				Date startTime = null;
				Date endTime = null;
				if(sumType==0){//查询全部
