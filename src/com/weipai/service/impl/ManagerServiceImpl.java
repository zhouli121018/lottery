...
public class ManagerServiceImpl implements ManagerService {
	...
	public static final int PORT = 10125;//服务器端口号  
...
//            json.put("error", "游戏端发送消息异常");
	...
	@Override
	public int selectManagerInfoByMapCount(Map<String, Object> map,int searchType) {
		Date startTime = null;
		Date endTime = null;
		if(searchType==0){//查询全部
			startTime = new Date(0L);
		...
		if(!map.containsKey("startTime"))
			...
			if(!map.containsKey("endTime"))
			map.put("endTime", endTime);
		return managerMapper.selectManagerInfoByMapCount(map);
	}
	
	@Override
	public List<Manager> selectManagerNewUserByMap(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return managerMapper.selectManagerNewUserByMap(map);
	}
	
	@Override
	public int selectManagerNewUserByMapCount(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return managerMapper.selectManagerNewUserByMapCount(map);
	}
