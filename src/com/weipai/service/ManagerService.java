...
public interface ManagerService {
    ...
    int selectManagerInfoByMapCount(Map<String, Object> map,int searchType);
    
    List<Manager> selectManagerNewUserByMap(Map<String, Object> map);
    int selectManagerNewUserByMapCount(Map<String, Object> map);
